  ...
  describe '出品情報登録' do
    ...
    context '出品情報登録ができないとき' do
      ...
      it 'category_idが---では登録できない' do
        ...
        unless category
          raise "Category with name '---' does not exist. Ensure the category exists in the ActiveHash data."
        end
      ...
      it 'condition_idが---では登録できない' do
        ...
        unless condition
          raise "Condition with name '---' does not exist. Ensure the condition exists in the ActiveHash data."
        end
